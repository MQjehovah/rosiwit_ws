...
#ifndef DIFFBOT_NAVIGATION__PLANNERS__NAVFN_PLANNER_HPP_
#define DIFFBOT_NAVIGATION__PLANNERS__NAVFN_PLANNER_HPP_
...
#endif  // DIFFBOT_NAVIGATION__PLANNERS__NAVFN_PLANNER_HPP_