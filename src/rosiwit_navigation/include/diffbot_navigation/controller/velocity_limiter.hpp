...
#ifndef DIFFBOT_NAVIGATION__CONTROLLER__VELOCITY_LIMITER_HPP_
#define DIFFBOT_NAVIGATION__CONTROLLER__VELOCITY_LIMITER_HPP_
...
#endif // DIFFBOT_NAVIGATION__CONTROLLER__VELOCITY_LIMITER_HPP_