...
#ifndef ROSIWIT_NAVIGATION__CONTROLLER__DIFF_DRIVE_CONTROLLER_HPP_
#define ROSIWIT_NAVIGATION__CONTROLLER__DIFF_DRIVE_CONTROLLER_HPP_
...
#endif // ROSIWIT_NAVIGATION__CONTROLLER__DIFF_DRIVE_CONTROLLER_HPP_