...
public:
    ...
    static pcl::PointCloud<pcl::PointXYZINormal>::Ptr ros2PCL(const sensor_msgs::msg::PointCloud2::SharedPtr msg, int filter_num, double min_range = 0.5, double max_range = 20.0);
